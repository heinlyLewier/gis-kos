        ...
        <div class="card border-0 mb-4" style="min-height: 50vh;">
            ...
            <div class="form-row pl-3 pr-3">
                <div class="form-group col-md-6">
                    ...
                    <input id="latitude" class="form-control" type="number" name="latitude" value="<?= $list->latitude; ?>" placeholder="Latitude" readonly>
                </div>
                <div class="form-group col-md-6">
                    <label for="">Longitude</label>
                    <input id="longitude" class="form-control" type="number" name="longitude" value="<?= $list->longitude; ?>" placeholder="Longitude" readonly>
                </div>
            </div>
        </div>
    </div>
