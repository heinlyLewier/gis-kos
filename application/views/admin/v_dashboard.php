...
<div class="row mx-auto">
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card row border-0 h-100 py-2  border-left-success border-right-0 border-bottom-0 border-top-0">
            <div class="card-body">
    ...
    <div class="col-xl-3 col-md-6 mb-4 ml-md-3">
        <div class="card row border-left-warning border-right-0 border-bottom-0 border-top-0 h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
