                        ...
                        foreach ($list->result() as $key => $value) { ?>
                            <?php if ($value->level != 'Admin') { ?>
                                <tr>
                                    ...
                                    <td style="width: 15rem;"><?= $value->nama; ?></td>
                                    <td style="width: 15rem;"><?= $value->username; ?></td>
                                    <td style="width: 15rem;"><?= $value->status; ?></td>
                                    <td style="width: 15rem;"><?= $value->level; ?></td>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-group-sm border-0" role="group" aria-label="b">
                                            ...
                                            <a name="" id="" class="btn btn-danger alert_notif" href="<?= site_url('admin/delete_user/') . $value->id_user . '/' . $value->img; ?>" role="button"><i class="fa fa-trash" aria-hidden="true"></i></a>
