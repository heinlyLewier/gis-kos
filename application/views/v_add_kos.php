        ...
        <div class="card border-0 mb-4" style="min-height: 50vh;">
            ...
            <div class="form-row pl-3 pr-3">
                <div class="form-group col-md-6">
                    ...
                    <input id="latitude" class="form-control" type="number" name="latitude" value="<?= set_value('latitude'); ?>" placeholder="Latitude" readonly>
                    <?= form_error('latitude', '<small class="text-danger">', '</small>'); ?>
                </div>
                <div class="form-group col-md-6">
                    <label for="">Longitude</label>
                    <input id="longitude" class="form-control" type="number" name="longitude" value="<?= set_value('longitude'); ?>" placeholder="Longitude" readonly>
    ...
    <div class="col-md-6">
        <div class="card border-0 mb-4">
            <div class="card-body">
                ...
                <button type="submit" class="btn btn-success btn-sm border-0" style="background-color:#298505 ;">Simpan</button>
            </div>
        </div>
    </div>
</div>
